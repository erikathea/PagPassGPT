...
ready4test_dataset="./dataset/${dataset_name}-cleaned-Test-ready.txt"
...
python concat_pattern_password.py --dataset_path=$test_dataset --output_path=$ready4test_dataset